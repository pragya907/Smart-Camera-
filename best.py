...
# Twilio credentials (Corrected)
TWILIO_ACCOUNT_SID = "**********************"
TWILIO_AUTH_TOKEN = "**********************"
TWILIO_PHONE_NUMBER = "+18314804037"  # Twilio number
ALERT_PHONE_NUMBER = "+918104152021"  # Recipient's phone number
...
while True:
    ...
    # Trigger alarm, SMS, and call if "knife" or "gun" is detected with > 80% confidence
    if (predicted_label.lower() == "knife" or predicted_label.lower() == "gun") and confidence > 0.80:
        play_alarm()
    ...
    # Reset alert flag if knife or gun is no longer detected
    if predicted_label.lower() not in ["knife", "gun"]:
        alert_sent = False
